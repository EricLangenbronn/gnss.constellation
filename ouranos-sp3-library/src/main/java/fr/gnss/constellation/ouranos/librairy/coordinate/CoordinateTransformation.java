...
public class CoordinateTransformation {
     ...
     *
     * @param phi     - latitude in radian
     * @param lambda  - longitude in radian
     ...
     * coordinates lie in.
     *
     * @param phi    - latitude (en radian)
     * @param lambda - longitude (en radian)
    ...
    public static TimeCoordinateSatellitePosition<SphericalCoordinate> transformCartesionToSpherical(TimeCoordinateSatellitePosition<CartesianCoordinate3D> timeCoordinateSatellitePositionCartesian, GeodeticCoordinate groundStation) {
    ...
    public static List<TimeCoordinateSatellitePosition<SphericalCoordinate>> transformCartesionsToSphericals(List<TimeCoordinateSatellitePosition<CartesianCoordinate3D>> timeCoordinateSatellitesPositionsCartesian, GeodeticCoordinate groundStation) {
        ...
        for (TimeCoordinateSatellitePosition<CartesianCoordinate3D> timeCoordinateSatellitePositionCartesian : timeCoordinateSatellitesPositionsCartesian) {
            timeCoordinateSatellitesPositionsSpherical.add(transformCartesionToSpherical(timeCoordinateSatellitePositionCartesian, groundStation));
        }
