...
public class Sp3File {
  ...
  public Sp3FileType getSp3FileType() throws IOException {
    ...
    if (this.sp3File.exists() && this.sp3File.isFile() && this.sp3File.canRead()) {
      ...
      String message = "Impossible d'acceder au fichier [sp3File=" + this.sp3File.getAbsolutePath() + "] [exists=" + this.sp3File.exists()
          + ", isFile=" + this.sp3File.isFile() + "]";
      throw new IOException(message);
    }
