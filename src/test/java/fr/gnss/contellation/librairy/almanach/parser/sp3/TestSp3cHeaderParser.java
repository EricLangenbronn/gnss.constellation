...
import fr.gnss.constellation.librairy.almanach.parser.sp3.Sp3cHeaderParser;
...
public class TestSp3cHeaderParser {
	...
	public static void loadFile() throws IOException {
		String sp3FileName = TestSp3cHeaderParser.class.getResource(
	...
	public void TestSatId() throws TechnicalException, BusinessException {
		...
		Assert.assertEquals(resStr, resExpected);
	}
