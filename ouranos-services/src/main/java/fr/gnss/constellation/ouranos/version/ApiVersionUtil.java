...
public class ApiVersionUtil {
    ...
    public Version getVersion(String version) throws VersionException {
        int numeroVersion = -1;
    ...
    public Version checkIfVersionOrPreviousIsContains(Version requestedVersion, List<Version> availabelVersion) throws VersionException {
