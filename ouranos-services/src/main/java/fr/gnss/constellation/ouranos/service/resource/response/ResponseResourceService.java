...
public class ResponseResourceService implements IResponseResourceService {
	...
	@Override
	public String getSateliteVisible(String resource, Version version, Map<String, Object> informations)
			throws TechnicalException, BusinessException {

		String template = this.templateService.getTemplate(resource, version);
