...
public class TestSp3FormatSecondLineTypeC {
	...
	public void testWhenParseSecondLine_thenMapDataOk() {
		...
		assertEquals("0.00000000", sp3Header.getsSecondsOfWeek());
		assertEquals("900.00000000", sp3Header.getEpochInterval());
		assertEquals("56648", sp3Header.getModJulDaySt());
		assertEquals("0.0000000000000", sp3Header.getFractionalDay());
	}
