...
public class TestGeodeticTransformation {
	...
	public void testGeodeticToCartesianStrasbourg() throws Exception {
		...
		double[] cartesianPosition = GeodeticTransformation.geodeticToCartesianWSG84(Math.toRadians(48.5839200),
	...
	public void testGeodeticToCartesianParis() throws Exception {
		...
		double[] cartesianPosition = GeodeticTransformation.geodeticToCartesianWSG84(Math.toRadians(48.8534100),
				Math.toRadians(2.3488000), 120.0);
	...
	public void testTransformECEFtoENUStrasbourg() throws Exception {
		...
		double[] resEver = GeodeticTransformation.transformECEFtoENU(Math.toRadians(48.5839200),
				Math.toRadians(7.7455300), cartesiantStationSatelite.getVector());
	...
	public void testCalcElevationAzimuthSat() throws Exception {
		...
		GeodeticCoordinate station = new GeodeticCoordinate(Math.toRadians(48.5839200), Math.toRadians(7.7455300),
				120.0);
		double[] cartesianStation = GeodeticTransformation.geodeticToCartesianWSG84(station.getLatitude(),
				station.getLongitude(), station.getAltitude());
		...
		double[] enuStationSateliteVector = GeodeticTransformation.transformECEFtoENU(station.getLatitude(),
				station.getLongitude(), stationSatelite.getVector());
