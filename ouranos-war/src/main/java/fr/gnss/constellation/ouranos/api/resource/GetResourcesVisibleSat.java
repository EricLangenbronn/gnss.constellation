...
public class GetResourcesVisibleSat {
	...
	public Response postVisiblesatelliteByPeriodXml(@ApiParam(value = "version of the api", required = true) @PathParam("version") final String version,
			@ApiParam(value = "submission request on xml", required = true) VisibleSateliteRequest p_contenu) throws BusinessException, TechnicalException {

		VisibleSatParamDTO visibleSatParamDTO = RequestXmlToVisibleSatParamDTOMapper.beanVisibleSateliteRequestToDTO(p_contenu);

		String response = processResourceService.processSatelliteVisibleByPeriod(version, visibleSatParamDTO);
	...
	@Produces(MediaType.APPLICATION_XML + ";charset=UTF-8")
	@Path("/{version}/byPeriod")
	public Response getVisiblesatelliteByPeriodBeanParam(@PathParam("version") final String version, @BeanParam VisibleSatParam visibleSatParam)
			throws BusinessException, TechnicalException {

		VisibleSatParamDTO visibleSatParamDTO = BeanParamToVisibleSatParamDTOMapper.beanVisibleSatParamToDTO(visibleSatParam);
