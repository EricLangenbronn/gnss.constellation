...
public abstract class AbstractOrbitDataService implements IOrbitDataService {
  ...
  @Override
  public List<TimeCoordinateSatellitePosition<CartesianCoordinate3D>> getCartesionPositionsForPeriod(
      LocalDateTime start, LocalDateTime end, EphemerideType ephemerideType, OrbitType orbitType) {
